...
// value instead of the null when the key is not in the map
class DefaultMap extends Map {
    ...
    get(key) {
        if (this.has(key)) {                // If the key is already in the map
            return super.get(key);        // return its value from the superclass
        }
        else {
            return this.defaultValue;       // else return the default value
        }
...
// It makes a Histogram object from the standard input, then prints the histogram.
